...
export async function getCustomers(req, res){
    try {
        const customers = await db.query("SELECT id, name, phone, cpf, TO_CHAR(birthday, 'YYYY-MM-DD') FROM customers;")
...
export async function getCustomerById(req, res){
    ...
    try {
        const customer = await db.query("SELECT id, name, phone, cpf, TO_CHAR(birthday, 'YYYY-MM-DD') FROM customers WHERE id=$1;", [id])
